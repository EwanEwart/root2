...
void tf1_16()
{
	...
	for (int i{};i<npointx;++i) { // populate 2n doubles
		xvec[i] = i*0.1;
...
as shown below:
we use as function parameter as the graph normalisation.
*/
